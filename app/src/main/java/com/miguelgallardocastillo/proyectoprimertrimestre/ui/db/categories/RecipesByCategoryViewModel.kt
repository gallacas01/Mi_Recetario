...
class RecipesByCategoryViewModel (db: FirebaseFirestore, uid: String) : ViewModel() {
    ...
    init {
        viewModelScope.launch(Dispatchers.Main) {
            ...
            val recetas = BDRepository.getCustomRecipesByCategory()
...
class RecipesByCategoryViewModelFactory(private val db: FirebaseFirestore, private val uid: String): ViewModelProvider.Factory{
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return RecipesByCategoryViewModel(db,uid) as T
    }
}